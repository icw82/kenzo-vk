...
* __ui__: Теперь при отключении модуля «Дополнения интерфейса» дочерняя
  опция «Раскругление» корректно выключаются. _Спасибо
  [Дмитрию](https://vk.com/id73046910) за наводку._
* __trash__: Скрытие миничата;
* __trash__: Скрытие записей, размещённых в группах платно;
* __trash__: Скрытие «актуальных фотографий»;
-->

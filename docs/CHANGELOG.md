...
FIX: стили активной записи в плеере; цвета накладываются? когда это происходит?;
TODO: Размер файла;
TODO: Кнопка в аудио-плеере;
...
TODO: Определение URL и продолжительности аудиозаписи без информации в DOM (Как?);
TODO: Обнаружение аудиозаписей-клонов;
TODO: Правильный фильтр, чтобы вместо flume не выдавал lumen;
TODO: Фильтры: битрейт, продолжительность, размер файла;
TODO: Совпадения в плейлистах;
...
TODO: (скробблинг) История скроблинга для неавторизированных;
TODO: (скробблинг) Индикация прогресса.
TODO: (скробблинг) Кнопка в избранное.

TODO: (видео) Кнопки в мини-плеере;
TODO: (видео) Определение источника видео при поиске;

TODO: Удалать шары групп и прочего;
-- TODO: Удалять шары групп, в которых я и так состою;
TODO: Индикация удалённых репостов (количество);
TODO: Нужно ли делать искустенную прокурутку для удаления всех репостов ленты?;
...
* Ссылка в сайдбаре на страницу с настройками расширения;

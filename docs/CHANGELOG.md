...
// TODO: Способ взаимодействия с неизолированным скриптом (криптография?)
...
* Теперь через контекстное меню можно взаимодействовать с прямой ссылкой на аудио-
    или видеозапись. _Для этого нужно нажать по кнопке правой кнопкой и выбрать
    соответсвующую команду (например, «Копировать адрес ссылки»)._

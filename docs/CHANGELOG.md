...
* __scrobbler__: Скробблер временно выпелен.
-->

#### 5.5.2 — 23 ноября 2017
* __ui__: При раскруглении индикаторы онлайна на аватаре
  сдвигаются ближе к имени. Отзывы и баг-репорты присетсвуются
  в [группе расширения](https://vk.com/kenzovk) и в трекере;
